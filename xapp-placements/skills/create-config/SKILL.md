...
Read `$CLAUDE_PLUGIN_ROOT/skills/schema-ref/references/schema-0.17.1.md` and `$CLAUDE_PLUGIN_ROOT/skills/schema-ref/references/presets.md` into your context. You will need them throughout.
...
1. Top JSONC header comment (3-4 lines: project name, SDK version 0.17.1, generated date, generator = `xapp-placements plugin`).
2. `_project` block.
