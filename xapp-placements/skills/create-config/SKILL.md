...
Read `$CLAUDE_PLUGIN_ROOT/skills/schema-ref/references/schema-0.18.0.md` and `$CLAUDE_PLUGIN_ROOT/skills/schema-ref/references/presets.md` into your context. You will need them throughout.
