...
Fast generator for XAppAdKit (xappsdk) ad placement config JSONC files. Output matches Xantus admin import format + SDK 0.11.9 schema.
...
- `/xapp-placements:schema-ref` — print canonical SDK 0.11.9 schema reference.
...
Pinned to `com.xantus:x-app-ad-kit-sdk:0.11.9`. Bump plugin when SDK schema changes.
