...
mkdir -p ~/.claude/plugins/cache/xappsdk/xapp-placements/0.8.2
cp -R /tmp/xappsdk/xapp-placements/* ~/.claude/plugins/cache/xappsdk/xapp-placements/0.8.2/
...
- `/xapp-placements:validate` — validate file against SDK 0.12.5 schema
...
SDK pinned: `com.xantus:x-app-ad-kit-sdk:0.12.5`.
